...
/**
 * blocks/taskchain_navigation/import.php
 *
 * @package    blocks
...
require_once($CFG->dirroot.'/blocks/taskchain_navigation/import_form.php');
...
// initialize form
$mform = new block_taskchain_navigation_import_form($url);
